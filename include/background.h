...
struct background
{
  ...
  // =========================================================================
  // UNIFIED SATURATION UNIVERSE: QUANTUM FLUID PARAMETERS
  // =========================================================================
  double qf_A;         /**< Vacuum Stiffness (Dark Energy limit) */
  double qf_B;         /**< Matter Content constant */
  double qf_alpha;     /**< Phase Transition Parameter */
  double qf_viscosity; /**< Shear viscosity parameter */
  // =========================================================================
  ...
  // =========================================================================
  // UNIFIED SATURATION UNIVERSE: QUANTUM FLUID INDICES
  // =========================================================================
  int index_bg_rho_qf;        /**< Quantum fluid density */
  int index_bg_w_qf;          /**< Quantum fluid equation of state */
  int index_bg_cs2_qf;        /**< Quantum fluid sound speed squared */
  // =========================================================================
