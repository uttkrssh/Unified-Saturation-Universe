...
int input_read_parameters_species(struct file_content * pfc,
  ...
  // =========================================================================
  // UNIFIED SATURATION UNIVERSE: READ QUANTUM FLUID PARAMETERS
  // =========================================================================
  // This section reads your theoretical constants from the .ini file
  class_read_double("qf_A", pba->qf_A);          // Vacuum Stiffness
  class_read_double("qf_B", pba->qf_B);          // Matter Content
  class_read_double("qf_alpha", pba->qf_alpha);  // Phase transition (<= 0.05)
  class_read_double("qf_viscosity", pba->qf_viscosity); // Shear viscosity (~0.8)
  // =========================================================================
...
int input_default_params(struct background *pba,
  ...
  // =========================================================================
  // UNIFIED SATURATION UNIVERSE: DEFAULT INITIALIZATION
  // =========================================================================
  pba->qf_A = 0.;
  pba->qf_B = 0.;
  pba->qf_alpha = 0.;
