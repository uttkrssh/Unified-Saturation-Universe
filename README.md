...
perturbations.c: Implemented scale-dependent sound speed  to model quantum pressure. This effectively suppresses small-scale power, addressing the "Missing Satellites Problem" in standard LambdaCDM.
...
Results: The following plots illustrate the difference between the standard LambdaCDM model and the Unified Saturation model:
CMB Power Spectrum: Notable shifts in the higher-order acoustic peaks.
Matter Power Spectrum: Significant suppression of power.
